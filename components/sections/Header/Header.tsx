...
export const Header = ({ activeSection, onNavClick }: HeaderProps) => {
  ...
  return (
    <div className="sticky top-0 left-0 right-0 z-[9999] w-full">
      {" "}
      {/* Container pai sticky */}
      <motion.header
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 p-2 rounded-xl bg-gradient-to-r from-gray-900/10 to-gray-800/5 backdrop-blur-sm border border-cyan-500/10 group-hover:border-cyan-400/20 transition-all duration-300">
              ...
              >
                <OptimizedImage
                  ...
                  height={32}
                  priority={true}
                  className="brightness-125 w-auto h-auto"
                />
            ...
            {navItems.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Underline animado com efeito de onda */}
                  <motion.div
                    className={`
                  ...
                  {/* Efeito de brilho pulsante para itens ativos */}
                  {isActive && (
                    <motion.div
          ...
          {/* Desktop CTA - Botão CV Melhorado */}
          <motion.div
          ...
          >
            ...
            >
              ...
              >
                {/* Ícone com animação de download */}
                <motion.div
                  className="relative"
                  whileHover={{
                    y: [0, -2, 0],
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <Rocket className="w-2 h-2 text-cyan-400" />
                  </motion.div>
                </motion.div>
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                variant="neon"
                size="sm"
                className="gap-2 backdrop-blur-sm relative overflow-hidden"
                onClick={() =>
                  window.open("/docs/curriculo-erick-reis.pdf", "_blank")
                }
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-cyan-400/10 to-blue-400/5"
                  initial={{ opacity: 0 }}
                  whileHover={{ opacity: 1 }}
                  transition={{ duration: 0.3 }}
                />
              ...
              <nav className="p-4 space-y-2">
                {navItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-transparent opacity-0"
                        whileHover={{ opacity: 1 }}
                        transition={{ duration: 0.2 }}
                      />
                ...
                >
                  ...
                  >
                    <Button
                      variant="neon"
                      className="w-full justify-center gap-2 backdrop-blur-sm relative overflow-hidden"
                      onClick={() =>
                        window.open("/docs/curriculo-erick-reis.pdf", "_blank")
                      }
                    >
